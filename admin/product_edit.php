                ...
                <div class="card-body">
                    <form action="product_edit_processor.php" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <label>Title</label>
                            <input type="text" name="title" class="form-control" placeholder="Give a Title" value="<?= $product->title ?>">
                        </div>
                        <div class="form-group">
                            <label>Price</label>
                            <input type="text" name="price" class="form-control" placeholder="Alternative Name" value="<?= $product->price ?>">

                        </div>

                        <div class="form-group">
                            <label>Caption</label>
                            <input type="text" name="caption" class="form-control" placeholder="Add a Caption" value="<?= $product->caption ?>">
                        </div>
                        <div class="form-group">
                            <label>Upload Picture</label>
                            <input type="file" name="picture" class="form-control" placeholder="Choose a file">
                            <img src="<?= $webroot . 'uploads/' . $product->src ?>" style="width:100px;height:100px">
                            <input name="old_picture" type="text" class="form-control" value="<?= $product->src ?>" />
                        </div>
                    <!-- <div class="form-group">
                    <label>Url</label>
